document.addEventListener('DOMContentLoaded', () => {
    ...
    const dots = document.querySelectorAll('.plet');
    ...
    function handleResponsive() {
        if (window.innerWidth <= 768) {
            ...
            document.querySelector('.carousel-pletter').style.display = 'block';
        } else {
            ...
            document.querySelector('.carousel-pletter').style.display = 'none';
        }
    }
